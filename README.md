...
`yt-defuwuck` is a maintained [uBlock Origin](https://github.com/gorhill/uBlock) fiwtew suite fow making YouTube wess annoying and mowe usabwe in a vewy opinionated way.
...
Dis pwoject is an independent open-source initiative and is not affiliated with, endorsed by, sponsored by, ow associated with Alphabet Inc., Google LLC, ow YouTube.
